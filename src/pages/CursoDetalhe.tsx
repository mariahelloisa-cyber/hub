...
import { usePublicCategories, usePublicCourses } from "@/hooks/usePublicData";
...
const CursoDetalhe = () => {
  ...
  const categoryLabel =
    publicCategories.find((c) => c.slug === course.category)?.label ??
    categoryOptions.find((c) => c.slug === course.category)?.label ??
    "Curso";
          ...
          <div className="container grid gap-8 lg:grid-cols-[1fr_380px]">
            ...
            <div className="space-y-6">
              <div className="overflow-hidden rounded-2xl border border-border bg-card shadow-card">
                <img
                  src={course.image ?? getAreaPhoto(course.name, course.area, course.category)}
                  alt={course.name}
                  loading="lazy"
                  width={1024}
                  height={640}
